...
public class PermissionRestController {
    ...
    @GetMapping
    @PreAuthorize("hasAuthority(T(com.tinash.cloud.utility.security.Permissions.Permission).READ)")
    ...
    @PostMapping
    @PreAuthorize("hasAuthority(T(com.tinash.cloud.utility.security.Permissions.Permission).CREATE)")
