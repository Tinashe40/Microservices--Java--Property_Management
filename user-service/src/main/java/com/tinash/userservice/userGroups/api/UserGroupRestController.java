package com.tinash.userservice.userGroups.api;
...
public class UserGroupRestController {
    ...
    @PostMapping
    @PreAuthorize("hasAuthority(T(com.tinash.cloud.utility.security.Permissions.UserGroup).CREATE)")
    ...
    @GetMapping
    @PreAuthorize("hasAuthority(T(com.tinash.cloud.utility.security.Permissions.UserGroup).READ)")
    ...
    @DeleteMapping("/{id}")
    @PreAuthorize("hasAuthority(T(com.tinash.cloud.utility.security.Permissions.UserGroup).DELETE)")
