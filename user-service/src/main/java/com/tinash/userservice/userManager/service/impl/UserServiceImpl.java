...
import com.tinash.userservice.email.EmailService;
...
import com.tinash.userservice.userManager.dto.UpdateUserDto;
import com.tinash.userservice.userManager.mapper.UserMapper;
import com.tinash.userservice.userManager.service.UserService;
import com.tinash.userservice.userManager.validation.UserValidator;
...
import static com.tinash.cloud.utility.security.util.SecurityUtils.*;
...
public class UserServiceImpl extends DomainServiceImpl<User, SignUpRequest, UpdateUserDto, UserDto> implements UserService {
    ...
    public void resetPassword(Long id, ResetPasswordRequest request) {
        User user = findEntityById(id);
        user.changePassword(passwordEncoder.encode(request.getNewPassword())); // Use the domain method
