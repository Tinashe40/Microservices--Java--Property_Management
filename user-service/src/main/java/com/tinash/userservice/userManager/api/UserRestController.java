package com.tinash.userservice.userManager.api;
...
public class UserRestController {
    ...
    @GetMapping
    @PreAuthorize("hasAuthority(T(com.tinash.cloud.utility.security.Permissions.User).READ)")
    ...
    @GetMapping("/{id}")
    @PreAuthorize("hasAuthority(T(com.tinash.cloud.utility.security.Permissions.User).READ) or @userServiceImpl.isCurrentUser(#id)")
    ...
    @DeleteMapping("/{id}")
    @PreAuthorize("hasAuthority(T(com.tinash.cloud.utility.security.Permissions.User).DELETE)")
    ...
    @PostMapping
    @PreAuthorize("hasAuthority(T(com.tinash.cloud.utility.security.Permissions.User).CREATE)")
    ...
    @PutMapping("/{id}")
    @PreAuthorize("hasAuthority(T(com.tinash.cloud.utility.security.Permissions.User).UPDATE) or @userServiceImpl.isCurrentUser(#id)")
    ...
    @PreAuthorize("hasAuthority(T(com.tinash.cloud.utility.security.Permissions.User).ASSIGN_GROUPS)")
    @ApiResponses(value = {
    ...
    @PreAuthorize("hasAuthority(T(com.tinash.cloud.utility.security.Permissions.User).ASSIGN_PERMISSIONS)")
    @ApiResponses(value = {
    ...
    @PreAuthorize("hasAuthority(T(com.tinash.cloud.utility.security.Permissions.User).DEACTIVATE)")
    ...
    @PreAuthorize("hasAuthority(T(com.tinash.cloud.utility.security.Permissions.User).UPDATE)")
    ...
    @PreAuthorize("hasAuthority(T(com.tinash.cloud.utility.security.Permissions.User).RESET_PASSWORD)")
