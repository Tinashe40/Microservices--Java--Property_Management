package com.tinash.propertyservice.presentation.rest;

import com.tinash.propertyservice.application.usecase.property.command.CreatePropertyCommand;
import com.tinash.propertyservice.application.usecase.property.command.CreatePropertyUseCase;
import com.tinash.propertyservice.application.usecase.property.query.GetPropertyQuery;
import com.tinash.propertyservice.application.usecase.property.query.GetPropertyUseCase;
import com.tinash.propertyservice.domain.model.property.PropertyDTO;
import com.tinash.propertyservice.presentation.dto.request.CreatePropertyRequest;
import com.tinash.propertyservice.presentation.dto.response.PropertyResponse;
